node('master') {
    ...
    stage('testing') {
        sshagent(['0b25bf4f-a4a8-4922-8d4c-6d88c1b3369c']) {
            sh 'ssh ubuntu@ec2-18-220-104-193.us-east-2.compute.amazonaws.com sudo rm -rf app'
    ...
    stage('deployment') {
        sshagent(['0b25bf4f-a4a8-4922-8d4c-6d88c1b3369c']) {
            sh 'ssh ubuntu@ec2-52-15-176-248.us-east-2.compute.amazonaws.com sudo rm -rf app'
